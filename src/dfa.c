...
// static wchar_t
   static wint_t  // MKG: REDHAT PATCH 12/22/06
  ...
  if (! lexleft)
    {
      if (eoferr != 0)
        ...
        // return -1;
        return WEOF; // MKG: REDHAT PATCH 12/22/06
    }
...
{
  //wchar_t wc, wc1, wc2;
  wint_t wc, wc1, wc2; // MKG: REDHAT PATCH 12/22/06
                  ...
                  if (c2 == ']')
                  ...
                  else
                    {
                      ...
                      if (!hard_LC_COLLATE) {
                        ...
                        /* WATCOM defines are to prevent:
                           Error! E1054: Expression must be constant
                         */
#ifndef __WATCOMC__
                        char expr[6] = { '[', c, '-', c2, ']', '\0' };
#else
                        /* MKG: This is fixed in CVS version 12/22/06 */
                        char expr[6];
                        expr[0] = '[';
                        expr[1] = c;
                        expr[2] = '-';
